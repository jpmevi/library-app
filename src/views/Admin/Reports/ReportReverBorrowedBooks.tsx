...
function ReportReverBorrowedBooks() {
    ...
    const fetchComments = async () => {
      try {
        const response = await fetch(
          "http://54.196.99.149:8085/api/v1/reports/never-borrowed-books"+"?page="+page,
          {
            method: "GET",
            headers: {
  ...
  return (
    ...
    <div className="appContainer">
      ...
      <div className="listCareersContainer">
        <h1 className="titleContainer">NEVER BORROWED BOOKS</h1>
...
export default ReportReverBorrowedBooks;
