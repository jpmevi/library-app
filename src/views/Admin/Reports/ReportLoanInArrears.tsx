...
function ReportLoanInArrears() {
  const columns: Column[] = [
    ...
    { id: "dueDate", label: "Return Date", minWidth: 150, align: "center" },
  ];
    ...
    const fetchComments = async () => {
      try {
        const response = await fetch(
          "http://54.196.99.149:8085/api/v1/reports/loans-in-arrears"+"?page="+page,
          {
            method: "GET",
            headers: {
  ...
  return (
    ...
    <div className="appContainer">
      ...
      <div className="listCareersContainer">
        <h1 className="titleContainer">LOANS IN ARREARS</h1>
...
export default ReportLoanInArrears;
